          ...
          <div className="container">
            <div className="navbar-header page-scroll">
              ...
              <a href="#hero" className="site-logo">
                <img src="assets/img/logo-sud.png" width="100" height="100" alt="logo" />
              </a>
            </div>
            <div className="main-menu" id="portfolio-perfect-collapse">
              <ul className="nav navbar-nav navbar-right">
                ...
                <li className="page-scroll"><a href="#recent_works">Recent Works</a></li>
                <li className="page-scroll"><a href="#upload_files">Upload Files</a></li>
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="page-scroll">
                <p className="job-title"><h1>(nome da pessoa online)</h1></p>
              </div>
            </div>
            <div className="col-md-6 text-right">
              <img src="assets/img/fotor-ai-20230729142241-transformed.png" width="350" height="400" alt="Tiago" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6 col-md-offset-3">
                ...
                <p>
                  Hello! I'm Tiago Gago, a developer in training, a lover of technology and constantly learning with the languages ​​and ways of working that programming presents to me. I'm currently doing some work including this one where you are, if you like what you see, get in touch with me through my social networks to be closer to my work and my developments over time in the area I'm studying as Full Stack Web Development.
                </p>
                <a
            ...
            <div className="row">
              ...
              <div className="col-sm-4">
                <div className="service">
                  ...
                  <h4>Front-end</h4>
                  <p>
                    As a Full Stack developer, I have experience in HTML5, CSS3, Java Script and a few other ways of working within these programming languages.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="portfolio" className="site-section section-portfolio">
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-md-4 col-xs-6">
                <div className="portfolio-item">
                  <img src="assets/img/Futuristic Card.png" className="img-res" alt="" />
                  <div className="portfolio-item-info">
              ...
              <div className="col-md-4 col-xs-6">
                <div className="portfolio-item">
                  <img src="assets/img/Digital Watch.png" className="img-res" alt="" />
                  <div className="portfolio-item-info">
                    <h4>Digital Watch</h4>
              ...
              <div className="col-md-4 col-xs-6">
                <div className="portfolio-item">
                  <img src="assets/img/Animation With Game Characters.png" className="img-res" alt="" />
                  <div className="portfolio-item-info">
        ...
        <section className="site-section section-counters text-center">
          <div className="container">
            <div className="row">
              ...
              <div className="col-sm-4 col-xs-12">
                <p className="counter start" data-to="6" data-speed="2000">0</p>
                <h4>Projects Done</h4>
              </div>
              <div className="col-sm-4 col-xs-12">
                <p
          ...
          <div className="modal-content">
            <div className="modal-header">
              <a className="close" data-dismiss="modal"
                ><span className="glyphicon glyphicon-remove"></span
              ></a>
              <img className="img-res" src="assets/img/Futuristic Card.png" alt="" />
            </div>
            <div className="modal-body">
          ...
          <div className="modal-content">
            <div className="modal-header">
              <a className="close" data-dismiss="modal"
                ><span className="glyphicon glyphicon-remove"></span
              ></a>
              <img className="img-res" src="assets/img/Digital Watch.png" alt="" />
            </div>
            <div className="modal-body">
          ...
          <div className="modal-content">
            <div className="modal-header">
              <a className="close" data-dismiss="modal"
                ><span className="glyphicon glyphicon-remove"></span
              ></a>
              <img className="img-res" src="assets/img/Animation With Game Characters1.png" alt="" />
            </div>
            <div className="modal-body">
